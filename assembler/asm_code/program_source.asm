...
; numbers
.equ  c_tile_bg     = 0x00    ; background tile number
...
.def  r_tmp0 = r21            ; temporary register 0
.def  r_tmp1 = r22            ; temporary register 1
.def  r_tmp2 = r23            ; temporary register 2
.def  r_tmp3 = r24            ; temporary register 3
.def  r_tmp4 = r25            ; temporary register 4
.def  r_tmp5 = r26            ; temporary register 5
...
INIT:
  ...
  lds   r_chord_note,a_chord  ; store note for first row TODO: a_chord finns inte
...
INPUT:
  ...
  lsl   r_qwert               ; shift q to the left to make room for w
  ...
  lds   r_tmp0,a_t
  or    r_qwert,r_qwert,r_tmp0
  lsl   r_qwert,1 ;TODO lsl och lsr måste ha en siffra
...
NO_NOTE:
  ...
  inc   r_tmp6                ; go to next sprite number TODO:reg finns ej

  dec   r_notes_to_draw       ; loop counter
  cp    r_notes_to_draw,0     ; condition check
  brne  DRAW_NOTE             ; keep looping/exit

  subi  r_y,r_y,c_chord_dist    ; move to position of next chord TODO:ska vara c?
